...
import com.wyb.conveter.ImageConverter;
import com.wyb.conveter.WordConverter;
import com.wyb.messagedelegate.MsgDelegate;
...
public class RabbitmqConfig {
    ...
    public SimpleMessageListenerContainer simpleMessageListenerContainer() {
        ...
        //创建消息监听适配器对象
        //自己创建一个消息委托器对象
        MessageListenerAdapter messageListenerAdapter = new MessageListenerAdapter(new MsgDelegate());
